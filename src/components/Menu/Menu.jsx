        ...
        <div className="menu-footer" ref={menuFooterColsRef}>
          ...
          <div className="menu-footer-col">
            <div className="socials">
              <div className="revealer">
                <a href="https://www.youtube.com/@sheryians">YouTube</a>
              </div>
              <div className="revealer">
                <a href="https://www.instagram.com/asadkhan.dev/">Instagram</a>
              </div>
              <div className="revealer">
                <a href="https://x.com/Asad_Khan1804">X</a>
              </div>
            </div>
          </div>
        </div>
